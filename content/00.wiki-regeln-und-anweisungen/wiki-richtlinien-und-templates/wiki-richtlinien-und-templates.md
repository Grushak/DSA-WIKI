...
---
title: "Wiki-Richtlinien für Obsidian & Quartz 5"
type: "meta"
tags: [dsa, meta, regeln, templates, obsidian, quartz]
aliases: []
---
...
tags: [dsa, npc]
aliases: []
image: "assets/bilder/npcs/{{title}}.jpg"
---
# 👤 {{title}}

## Optik & Erscheinungsbild
*Körperbau, Kleidung (z. B. Neersander Gambeson, zerschlissenes Seidengewand), markante Merkmale und wie die Person im Raum wirkt.*

## Verhalten & Mentalität
*Wie spricht und handelt die Person? Ist sie pragmatisch, direkt, emotional, arrogant oder verschwiegen?*

## Bekannte Verbindungen
- **Zugehörigkeit:** [[organisation|Fraktion / Sippe]]
- **Verbündete:** [[freund|Name]]
- **Feinde:** [[feind|Name]]

%%
## SL-Bereich
## Spielwerte & Meister-Daten
- **Wahre Motivation:** *Was treibt die Person im Hintergrund an (z. B. Rache, Gier nach Trug-Gold, Erhalt der Adelsherrschaft)?*
- **Geheimnisse / Schwächen:** *Kompromittierendes Material, Leichen im Keller, Pakt-Ansätze.*
- **Kampfwerte (Crunch):**
    * *LeP:* 30 | *AsP/KaP:* - | *RS:* 3
    * *Waffen:* [[borndorne|Wurfmesser]] (AT 13, TP 1W6+2)
    * *Wichtige Talente:* Menschenkenntnis 12, Überreden 10, Verbergen 8
%%
```

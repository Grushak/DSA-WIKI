...
Das Hafenviertel ist ein logistischer Flaschenhals, der durch Zoll und Schmuggel definiert wird:

1. **Die Zoll-Autorität:** Das Hafenmeisteramt und die bewaffneten Zöllner haben hier mehr Macht als Timpskis Stadtgarde. Jedes Schiff, jede Kiste muss offiziell deklariert werden.
    
2. **Das Schmiergeld-System (Das inoffizielle Gesetz):** Nichts funktioniert ohne Bestechung. Ein paar Silberlinge an den richtigen Zöllner sorgen dafür, dass Fässer (wie das des Zwergs Ragnosch) nicht geöffnet werden.
    
3. **Das ungeschriebene Gesetz der Schauerleute:** Wer den Hafenarbeitern Arbeit wegnimmt oder sie bestiehlt, landet beschwert mit Ankerketten im Hafenbecken. Sie sind gewerkschaftsähnlich organisiert.
    

---

## 🪓 Sub-System: Das Thorwaler-Viertel (Die kulturelle Enklave)

_Dieses Areal funktioniert als eigenständiges, isoliertes Rechtssystem innerhalb des westlichen Hafens._
...
## 🏛️ Besondere Orte & Infrastruktur im Hafen

Das Hafenviertel bündelt die geballte Logistik und die verborgenen Netzwerke Festums.

|**Kategorie**|**Name / Ort**|**Funktion & Nutzen für die Kampagne**|
|---|---|---|
|**Logistik**|**Das Hafenmeisteramt & Zollbrücke**|Hier liegen alle Frachtpapiere. Wer herausfinden will, wo der Schwarze Lotos seine Ware anlandet, muss hier einbrechen oder Beamte bestechen.|
|**Militär**|**Adelsmarschall-Gulnitz-Bastion**|Eine wehrhafte Festung, die den Hafen schützt. Ein extrem riskantes Ziel, aber nützlich, um militärische Dienstpläne abzufangen.|
|**Religion**|**Hafentempel des Efferd (am Efferdplatz)**|Zentrales Heiligtum des Hafens. Der Tempel kümmert sich um die Opfer des Meeres. Ein neutraler Ort für heimliche Treffen. Direkt daneben liegt das **Haus der Efferdbrüder**.|
|**Religion (Enklave)**|**Gottwalsâl (Swafnir-Tempel)**|Massives, schiffsrumpfförmiges Langhaus im Thorwaler-Viertel. Spirituelles Zentrum für Eide und Segen der Nordleute.|
|**Religion (Unterwelt)**|**Phexens Tempel des Fuchses**|Liegt versteckt im _Oberen Hafen_. Der absolute Knotenpunkt für Hehler, Diebe und den Kauf geheimer Informationen.|
|**Religion (Söldner)**|**Altar des Kor**|Ein blutiger, pragmatischer Kultort. Hier lassen sich skrupellose Söldner anheuern, die keine unangenehmen Fragen stellen.|
|**Kultur**|**Philmor Ousts Konzerthalle**|Ein überraschender Ort der Kunst mitten im rauen Hafen. Ideal für konspirative Treffen während lauter Vorstellungen.|
|**Taverne (Enklave)**|**Das Sieben-Winde-Haus**|Lauteste Kneipe der Thorwaler. Zentraler Treffpunkt für Kapitäne. Hier brodelt der Hass auf die Festumer Patrioten.|
|**Taverne (Hafen)**|**Die Ahab-Stube**|Ein kleines, extrem dunkles und raues Lokal der Walfänger. Sehr verschwiegenes Klientel.|
|**Taverne (Hafen)**|**Der Silberne Aal**|Verrauchte Spelunke direkt an den Kais. Das absolute Epizentrum für Schmuggel. _(Hier operiert vermutlich Gnorosch)._|
|**Handwerk**|**Die Werften & Tempel des Erdfeuers**|Riegen voller Teer, Holz und Schiffe im Bau. Der nahe Ingerimm-Tempel liefert exzellente metallurgische Arbeit. Perfekt für das Beschaffen von Werkzeug.|
